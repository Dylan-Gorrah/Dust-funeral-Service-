        ...
        <div className="space-y-16 md:space-y-24">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              >
                <div className="bg-beige-light p-6 md:p-8 rounded-sm flex items-center justify-center aspect-square max-w-[200px] mx-auto">
                  <reason.icon className="text-gold" size={60} strokeWidth={1} />
                </div>
              </motion.div>
