          ...
          >
            ...
            <div className="space-y-6">
              ...
              <motion.a
                ...
                className="flex items-center gap-4 p-6 bg-white rounded-sm shadow-sm hover:shadow-md transition-all duration-300 group"
              >
                <div className="bg-gold/10 p-4 rounded-sm group-hover:bg-gold/20 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-3xl font-display text-charcoal group-hover:text-gold transition-colors">
                    051-123-4567
                  </div>
                </div>
              </motion.a>
          ...
          >
            <div className="bg-white p-8 rounded-sm shadow-lg">
              ...
              <p className="text-charcoal/60 mb-6">
                Or press the call button above
              </p>
